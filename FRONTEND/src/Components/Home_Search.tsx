...
const Home_Search = () => {
  ...
  return (
    <>
      <div className='before:absolute bg-[#c3c0c2] bg-opacity-50  after:relative h-[600px]' ref={secondSectionRef} style={{ backgroundImage: `url(${hero})`, backgroundSize: 'cover', backgroundPosition: 'center',position: 'relative' }}>
