...
import Propertydetaillisted from '../Components/propertydetaillisted';
...
const listedpropertydetailspage = () => {
...
export default listedpropertydetailspage