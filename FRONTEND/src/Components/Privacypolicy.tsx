...
const Privacypolicy = () => {
    return (
        <div className="container mx-auto p-8">
            ...
            <p className="mb-4">
                This Privacy Policy applies between you, the User of this Website, and visahelp limited, the owner and provider of this Website. visahelp limited takes the privacy of your information very seriously. This Privacy Policy applies to our use of any and all Data collected by us or provided by you in relation to your use of the Website.
            </p>
            <p className="mb-4">
                This Privacy Policy should be read alongside, and in addition to, our Terms and Conditions, which can be found at: <a href="www.getmyroom.co.uk" className="text-blue-500">www.getmyroom.co.uk</a>.
            </p>
            <p className="mb-4">
                Please read this Privacy Policy carefully.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4"> Definitions and Interpretation</h2>
            ...
            <p className="mb-4 text-lg">
                3. 	This Privacy Policy applies only to the actions of visahelp limited and Users with respect to this Website. It does not extend to any websites that can be accessed from this Website including, but not limited to, any links we may provide to social media websites.

            </p>
            <p className="mb-4 text-lg">
                4. For purposes of the applicable Data Protection Laws, visahelp limited is the "data controller". This means that visahelp limited determines the purposes for which, and the manner in which, your Data is processed.
            </p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">How We Collect Data</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Who We Share Data With</h2>
            <p className="mb-4 text-lg">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Keeping Data Secure</h2>
            <p className="mb-4 text-lg">
            ...
            <p className="mb-4 text-lg">
                15. Technical and organisational measures include measures to deal with any suspected data breach. If you suspect any misuse or loss or unauthorised access to your Data, please let us know immediately by contacting us via this e-mail address: alvin.vncnt@gmail.com.
            </p>
            <p className="mb-4 text-lg">
            ...
            <ol className="list-decimal ml-6 mb-4">
                ...
                <li><strong>Right to access</strong>- the right to have your Data rectified if it is inaccurate or incomplete.</li>
            ...
            <p className="mb-4 text-lg">
                20.	To make enquiries, exercise any of your rights set out above, or withdraw your consent to the processing of your Data (where consent is our legal basis for processing your Data), please contact us via this e-mail address: alvin.
                vncnt@gmail.com.
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Changes of Business Ownership and Control</h2>
            <p className="mb-4 text-lg">
                24. visahelp limited may, from time to time, expand or reduce our business and this may involve the sale and/or the transfer of control of all or part of visahelp limited. Data provided by Users will, where it is relevant to any part of our business so transferred, be transferred along with that part and the new owner or newly controlling party will, under the terms of this Privacy Policy, be permitted to use the Data for the purposes for which it was originally supplied to us.
            ...
            <p className="mb-4 text-lg">
                32. This Privacy Policy was created using a document from Rocket Lawyer (https://www.rocketlawyer.com/gb/en).

            </p>
            <p className="mb-4 text-lg">
                This Privacy Policy was created on<strong>28 December 2023.</strong>
            </p>
