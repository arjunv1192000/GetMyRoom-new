    ...
    return (
        <div className=" w-[80%] h-auto bg-white border border-gray-200 rounded-lg shadow  hover:bg-gray-100 overflow-hidden   mt-20" >
            <div className="flex flex-col sm:flex-row" onClick={() => navigate(`/details?Id=${Id}`)}>
                <img className="object-fill w-full h-60 sm:w-2/6" src={image[0]} alt="" />
                <div className='w-full flex flex-col'>
                    <div className='w-full ml-2 sm:ml-10 md:ml-5'>
                        <h2 className=" flex font-semibold text-gray-900 text-[20px] sm:text-[28px] md:text-[26px] lg:text-[30px] ">{title}</h2>

                    </div>
                    <div className='w-auto ml-2  sm:w-1/2 sm:ml-10 md:ml-5'>

                        <h2 className="font-semibold text-gray-900 text-[16px] sm:text-[28px] md:text-[24px] lg:text-[28px]">£{price}/month</h2>

                    </div>
                    <div className='w-auto ml-2 mt-3 sm:w-1/2 flex flex-row sm:ml-10 sm:mt-2 md:ml-5'>
                        <FaMapMarkerAlt className="w-3 h-3 mt-1 sm:mt-1.5" />
                        <h2 className="flex  justify-start font-semibold text-gray-900 text-[12px] sm:text-[28px] md:text-[22px] lg:text-[18px] ml-3">{location.locationName}</h2>

                    </div>

                    <div className="w-full  h-20 flex flex-row gap-4 sm:mt-6 sm:ml-10 md:ml-5">
            ...
            <div className='w-full h-20  flex justify-between'>
                <div className="flex items-center w-1/2">
                    <div className="flex-shrink-0 ml-3">
                        {userimage && userimage !== 'Not available' ? (
