...
const commonserviceController=()=>{
    ...
    const createemail=(req,res)=>{
        ...
        const {fullname,email,message,useremail,propertyname,location,name}=req.body

        Nodemailer(fullname,email,message,useremail,propertyname,location,name).then((response)=>{
